...
import TinyBarChart from "../../Components/Chart/Chart";
...
function FarmerDashboard() {
  ...
  return (
    <>
      ...
      {/* <div className="flex h-full bg-[#F6F8F7] text-gray-800">
        <aside className=" hidden md:w-64 md:block bg-white p-6 shadow-sm">
          <h1 className="text-xl font-bold text-green-800 mb-8">AGRISURE</h1>
          <nav className="space-y-4">
            <div className="text-green-700 font-semibold">Overview</div>
            <div className="text-gray-500">Portfolio</div>
            <div className="text-gray-500">Risk Assessment</div>
            <div className="text-gray-500">Lending</div>
        ...
        <main className="flex-1 p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm">
              <h3 className="text-sm text-gray-500 mb-4">SELECT COMMODITY</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {["Maize", "Rice", "Cassava", "Soybeans"].map((crop) => (
                  <div
                    key={crop}
            ...
            <div className="col-span-2 bg-green-900 text-white p-6 rounded-2xl shadow-lg">
              <div className="flex flex-wrap md:flex-nowrap justify-between">
                <div>
                  <p className="text-sm opacity-80">ACTIVE ANALYSIS</p>
                  <h1 className="text-5xl font-bold">7.2</h1>
                  <p className="opacity-80">Projected Yield</p>
                </div>
                <div className="text-right">
                  <p className="text-sm opacity-80">TOTAL AREA</p>
                  <h2 className="text-xl">3.0 Hectares</h2>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm space-y-4">
              <h3 className="text-sm text-gray-500">FARM INPUTS</h3>
              <input
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm text-center">
              <h3 className="text-sm text-gray-500">RISK ASSESSMENT</h3>
              <div className="text-4xl font-bold text-green-700 mt-4">B+</div>
              <p className="text-sm text-gray-500">Stable</p>
            </div>

            
            <div className="bg-white p-6 rounded-2xl shadow-sm">
              <h3 className="text-sm text-gray-500">LENDING DECISION</h3>
              <div className="bg-green-100 p-4 rounded-xl mt-4">
                <p className="text-green-800 font-semibold">PRE-APPROVED</p>
                <h2 className="text-2xl font-bold">$4,500</h2>
              </div>
              <button className="mt-4 w-full bg-green-800 text-white py-2 rounded-xl">
